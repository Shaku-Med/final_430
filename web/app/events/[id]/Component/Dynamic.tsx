...
import { SocialInteractions } from '@/app/dashboard/events/components/SocialInteractions'
...
export default function EventDynamic({data}: {data: Event}) {
            ...
            >
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
                ...
                <div className="space-y-4 sm:space-y-6">
                  <Card className="border-0 shadow-lg p-0 / dark:bg-gray-800/80 backdrop-blur-sm">
                      ...
                      <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t overflow-hidden">
                        {
                                ...
                                />
                                    ...
                                    <>
                                       <Link href={`/account`} className="flex py-4 px-2 items-center justify-between w-full gap-2">
                                            <div 
              ...
              <div className="w-full max-w-4xl mx-auto">
                {data.isAuth ? (
                  ...
                  <div className="text-center bg-card rounded-xl border shadow-lg p-6 sm:p-8 ">
