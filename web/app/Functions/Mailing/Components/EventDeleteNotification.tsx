...
interface EventDeleteNotificationEmailProps {
  eventTitle: string;
  eventDate: string;
...
const EventDeleteNotificationEmail: React.FC<EventDeleteNotificationEmailProps> = ({
  eventTitle,
  eventDate,
  eventLocation,
  userName,
    ...
    <>
      ...
      <div className="flex flex-col items-center w-full max-w-xl mx-auto bg-gray-50 shadow-lg overflow-hidden font-sans rounded-lg">
        ...
        <div className="w-full px-8 py-6">
          <h2 className="text-xl font-semibold mb-4">Event Deletion Notice</h2>
          <p className="mb-4">Dear {userName},</p>
          <p className="mb-4">We regret to inform you that your event has been deleted by an administrator.</p>
...
export default EventDeleteNotificationEmail; 