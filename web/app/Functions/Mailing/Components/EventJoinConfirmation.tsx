...
interface EventJoinConfirmationEmailProps {
  eventTitle: string;
  eventDate: string;
...
const EventJoinConfirmationEmail: React.FC<EventJoinConfirmationEmailProps> = ({
  eventTitle,
  eventDate,
  eventLocation,
  userName,
    ...
    <>
      ...
      <div className="flex flex-col items-center w-full max-w-xl mx-auto bg-gray-50 shadow-lg overflow-hidden font-sans rounded-lg">
        ...
        <div className="w-full px-8 py-6">
          <h2 className="text-xl font-semibold mb-4">Welcome to the Event!</h2>
          <p className="mb-4">Dear {userName},</p>
          
          <p className="mb-4">Thank you for joining our event. We're excited to have you on board!</p>
          ...
          <div className="mb-6 bg-white p-4 rounded-lg shadow-sm">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-600">
              <li>You'll receive email notifications about any updates to this event</li>
              <li>Stay tuned for new comments and announcements</li>
              <li>You can view all event details in your dashboard</li>
            </ul>
          </div>
...
export default EventJoinConfirmationEmail; 